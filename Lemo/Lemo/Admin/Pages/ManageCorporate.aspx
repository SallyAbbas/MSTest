<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageCorporate.aspx.cs" Inherits="Lemo.Admin.Pages.ManageCorporate" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Company">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblCompany" Text='<%# Eval("Name") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                          <%--  <asp:TemplateField HeaderText="State">
                           ...
                           <%-- <asp:TemplateField HeaderText="City">
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:Button Text="Edit" runat="server" ID="butEdit" CommandName='<%# Eval("ID") %>'
                                        OnClick="butEdit_onClick" />
                                </ItemTemplate>                               
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Delete">
                                    <itemtemplate>
                                    <asp:Button Text="Delete" runat="server" ID="butDelete" CommandName='<%# Eval("ID") %>'
                                        OnClick="butDelete_onClick" />
                                </itemtemplate>
                                </asp:TemplateField>
                            <asp:TemplateField HeaderText="Login">
                                <ItemTemplate>
                                    <asp:Button Text="Login as Affiliate" runat="server" ID="butLoginAfflite" CommandName='<%# Eval("ID") %>'
