    ...
    function callback(results, status, pagination) {
        ...
        if (status == google.maps.places.PlacesServiceStatus.OK) {
            for (var i = 0; i < results.length; i++) {
                ...
                var temp = lat.toString().substring(0, 5) + "," + lng.toString().substring(0, 5);
//                //jb
//                var temp;
...
//                    temp = lattt + "," + results[i].geometry.location.ib.toString().substring(0, 5);
//                }
//                else if(typeof results[i].geometry.location.jb === "undifined" && results[i].geometry.location.jb != null)
//                {
//                    var lattt = results[i].geometry.location.jb.toString().substring(0, 5);
//                    temp = results[i].geometry.location.ib.toString().substring(0, 5) + "," + lattt;
//                }
//                else 
//                {
//                    var lattt = results[i].geometry.location.kb.toString().substring(0, 5);
//                    temp = lattt + "," + results[i].geometry.location.lb.toString().substring(0, 5) ;
//                }
