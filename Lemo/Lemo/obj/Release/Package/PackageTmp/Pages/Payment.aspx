        ...
        <table width="100%" class="PaymentLable">
            ...
            <tr>
                <td style="width: 75%; padding: 10px 15px 15px;" valign="top;">
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtCardNumber" Width="260px"></asp:TextBox>
                    ...
                    <div style="text-align: center; background-color: #C6C3CA; border-radius: 5px 5px 5px 5px;">
                        <asp:CheckBox runat="server" ID="cbTermsConditions" ClientIDMode="Static" />
                        <span style="font-weight: bold;" cssclass="Lable">I agree to <a target="_blank" href="TermsConditions.aspx">
