<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddContactPerson.ascx.cs"
    Inherits="Lemo.Admin.Controls.AddContactPerson" %>
<div style="padding: 5px; margin: 5px;">    
    ...
    <asp:Label runat="server" ID="lblError" Text="The username you selected for this account already exists. Please select another username"
        ...
        <fieldset>
            <legend>
                <asp:Label runat="server" ID="Label1" Text="Contact Person" CssClass="TitleInnerPage"></asp:Label></legend>
            <table>
                <tr>
                    <td class="style1">
                ...
                <tr>
                    <td class="style1" colspan="2">
                        ...
                        <br />
                        <asp:TextBox ID="txtJob" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                            ControlToValidate="txtJob" ErrorMessage="Required" ID="RequiredFieldValidator4"
                            ValidationGroup="vgSignUp" runat="server" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
