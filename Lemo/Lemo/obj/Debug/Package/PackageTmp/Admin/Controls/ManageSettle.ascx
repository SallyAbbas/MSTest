<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManageSettle.ascx.cs"
    Inherits="Lemo.Admin.Controls.ManageSettle" %>
    ...
    <table width="100%">
        <tr>
            <td>
                ...
                <asp:TextBox ID="txtDatepicker" runat="server" Width="80" AutoPostBack="true" OnTextChanged="txtDatepicker_TextChanged"></asp:TextBox>
