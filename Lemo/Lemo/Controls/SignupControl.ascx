<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SignupControl.ascx.cs"
    Inherits="Lemo.Controls.SignupControl" %>
<style type="text/css">
    .style1
    {
        width: 431px;
...
<div style="padding: 5px; margin: 5px;">
    ...
    <div style="width: 75%; text-align: left;">
        <fieldset>
            <legend>
                <asp:Label runat="server" ID="Label1" Text="Create New Account" CssClass="TitleInnerPage"></asp:Label></legend>
            <table>
                <tr>
                    <td class="style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblInviteCode" runat="server" Text="Invite Code"></asp:Label>
                        <br />
                        <asp:TextBox ID="txtInviteCode" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style1">
                ...
                <tr>
                    <td colspan="2" align="right">                        
                            <asp:ImageButton runat="server" ID="ImageButton1" ImageUrl="~/Image/signupbtn.png" 
