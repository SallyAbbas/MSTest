<%@ Page AutoEventWireup="true" Language="C#" MasterPageFile="~/Pages/States/Master/StateMaster.master" Title="" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent1" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent1" runat="server">
    <div style="width: 100%;">
        <div style="background-image: url('../../Image/stats/Albuquerque.jpg');" class="StateHeader">
        </div>
